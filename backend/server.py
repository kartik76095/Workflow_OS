...
# Note: Temporarily disabled due to dependency ordering issues
# Will be re-enabled after fixing function dependencies

@api_router.get("/organizations/current")
async def get_current_organization_temp():
    """Get current organization (temporary endpoint)"""
    return {
        "id": "demo-org",
